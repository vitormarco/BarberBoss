...
namespace BarberBoss.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Date of income cannot be in future.
        /// </summary>
        public static string INCOME_DATE_CANNOT_BE_IN_FUTTURE {
            get {
                return ResourceManager.GetString("INCOME_DATE_CANNOT_BE_IN_FUTTURE", resourceCulture);
            }
        }
